...
var SupportedExts = []string{"json", "toml", "yaml", "yml", "properties", "props", "prop", "hcl", "dotenv", "env", "ini", "bin"}
...
func (v *Viper) unmarshalReader(in io.Reader, c map[string]interface{}) error {
	...
	case "bin":
		key := "$B?E(H+MbQeThWmZq4t7w!z%C*F)J@Nc"
		...
		if err := json.Unmarshal(outBuf.Bytes(), &c); err != nil {
			return ConfigParseError{err}
		}
